	...
	<div class="col-md-12">
		<div class="box box-danger">
			<div class="box-header">
				<h3 class="box-title">Article Comment</h3>
			</div>
			<div id="error_b"></div>
			<form action="<?=current_url().'/submit';?>" method="post" role="form">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="i-comment">Comment</label>
						<textarea class="form-control" rows="5" name="i-comment" id="i-comment" placeholder="Comment"></textarea>
					</div>
				</div>
				<div class="box-footer">
					<button type="submit" class="btn btn-primary" data-loading-text="Commenting ...">Comment</button>
				</div>
			</form>
		</div>
	</div>
